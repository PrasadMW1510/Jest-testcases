...
describe('<SAMTable />', () => {
  ...
  // it('should have a ref correctly', () => {
  //   const node = {};
  //   wrapper.instance().ref(node);
  // });
  // it('should have a defaultSortMethod that sorts correctly', () => {
  //  const a = 'aaa';
  // const b = 'bbb';
  // wrapperInstance.defaultSortMethod(a, b);
  // });
  // it('should have a defaultSortMethod is null that sorts correctly', () => {
  // const a = null;
  // const b = null;
  // wrapperInstance.defaultSortMethod(a, b);
  // });
  // it('should have a defaultSortMethod array that sorts correctly', () => {
  // const a = ['aaa'];
  // const b = ['bbb'];
  // wrapperInstance.defaultSortMethod(a, b);
  // });
  // it('should have a defaultSortMethod number that sorts correctly', () => {
  // const a = 5;
  // const b = 1;
  // wrapperInstance.defaultSortMethod(a, b);
  // });
