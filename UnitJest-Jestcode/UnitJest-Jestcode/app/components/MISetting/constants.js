...
export const STARTING_GRADE_INDEX = 0;

export const TAB_ADVANCED_SETTINGS_EDITABLE_INSTRUCTIONS = `Use these options to customize performance level names and ranges. You may change and \
    select one as the target proficiency level using the pull-down menus below \
    the chart.`;
export const TAB_ADVANCED_SETTINGS_GRADE_9_AND_ABOVE_TEXT = `For students in Grade 9 and above, performance levels describe the performance \
    of students in Algebra I and Math I.`;
...
export const MI_SETTINGS_CHECKBOX_STATUS_MAP = {
