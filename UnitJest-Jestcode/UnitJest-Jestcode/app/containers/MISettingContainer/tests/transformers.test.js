...
describe('MISettingContainer transformers', () => {
  ...
  describe('transformScore', () => {
    it('should transform undefined correctly', () => {
      expect(Transformers.transformScore(undefined)).toEqual('?');
    });

    it('should transform highest value correctly', () => {
      expect(Transformers.transformScore(1760, 1, 'Advanced')).toEqual('1760+');
    });

    it('should transform negatives correctly', () => {
      expect(Transformers.transformScore(-1)).toEqual('EM1');
    });

    it('should transform regular values correctly', () => {
      expect(Transformers.transformScore(1095)).toEqual('1095');
    });
  });
});
