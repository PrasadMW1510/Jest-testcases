...
import { DeactivateSuccessStudentModalContainer } from '../DeactivateSuccessStudentModalContainer';

describe('<DeactivateSuccessStudentModalContainer />', () => {
  let wrapper = null;
  ...
  it('should have a DeactivateStudentSuccessModal', () => {
    const modal = wrapper.find('DeactivateStudentSuccessModal');
