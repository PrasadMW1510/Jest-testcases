...
import DeactivateClassSuccessModal from 'components/DeactivateClassSuccessModal/DeactivateClassSuccessModal';
...
export function DeactivateSuccessClassModalContainer(props) {
  const handleYes = e => {
    e.preventDefault();
    props.hideModal();
    props.hideModal();
  ...
  return <DeactivateClassSuccessModal isOpen onYes={handleYes} />;
}

DeactivateSuccessClassModalContainer.propTypes = {
...
export default compose(withRouter, withConnect)(DeactivateSuccessClassModalContainer);
