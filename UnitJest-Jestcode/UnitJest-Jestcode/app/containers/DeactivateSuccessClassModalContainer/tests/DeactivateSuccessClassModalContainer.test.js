...
import { DeactivateSuccessClassModalContainer } from '../DeactivateSuccessClassModalContainer';

describe('<DeactivateSuccessClassModalContainer />', () => {
  let wrapper = null;
  ...
  it('should have a DeactivateClassSuccessModal', () => {
    const modal = wrapper.find('DeactivateClassSuccessModal');
